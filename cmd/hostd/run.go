...
import (
	...
	"go.thebigfile.com/hostd/alerts"
	"go.thebigfile.com/hostd/api"
	"go.thebigfile.com/hostd/config"
	"go.thebigfile.com/hostd/explorer"
	"go.thebigfile.com/hostd/host/accounts"
	"go.thebigfile.com/hostd/host/contracts"
	"go.thebigfile.com/hostd/host/registry"
	...
	"go.thebigfile.com/hostd/webhooks"
	"go.sia.tech/jape"
